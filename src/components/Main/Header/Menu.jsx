            ...
            <div className="container-fluid">
                <div id="navigation">
                    <ul className="navigation-menu">
                        ...
                        <li className="has-submenu">
                            <a href="#"><i className="icon-layers"></i> Apps
                        ...
                        <li className="has-submenu">
                            <a href="#"> <i className="icon-briefcase"></i> UI Elements
                                <div className="arrow-down"></div>
                            </a>
                        ...
                        <li className="has-submenu">
                            <a href="#"> <i className="icon-fire"></i>Components
                                <div className="arrow-down"></div>
                            </a>
                            <ul className="submenu">
                        ...
                        <li className="has-submenu">
                            <a href="#"> <i className="icon-docs"></i> Pages
                                <div className="arrow-down"></div>
                            </a>
                            <ul className="submenu megamenu">
                                <li>
                        ...
                        <li className="has-submenu">
                            <a href="#"> <i className="icon-present"></i> Extra Pages
                                <div className="arrow-down"></div>
                            </a>
